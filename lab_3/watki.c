...
int main() {
	...
	if(wynik == PTHREAD_CANCELED) {
		printf("\twatek glowny: odlaczony watek potomny zostal zabity\n");
	} else {
		printf("\twatek glowny: odlaczony watek potomny NIE zostal zabity - blad\n");
	}
	//
	...
	i = pthread_create(&tid, &attr, zadanie_watku, NULL);
